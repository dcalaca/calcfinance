...
-- 9. Políticas de segurança para finance_users
...
-- 10. Políticas de segurança para finance_calculations
...
-- 11. Políticas de segurança para finance_user_preferences
...
-- 12. Políticas de segurança para finance_alerts
...
-- 13. Políticas para calculation_templates
...
-- 14. Política para currency_rates (leitura pública)
ALTER TABLE public.currency_rates ENABLE ROW LEVEL SECURITY;
CREATE POLICY "currency_rates_select_all" ON public.currency_rates
  FOR SELECT USING (true);

-- 15. Função para criar perfil automaticamente após signup
...
-- 16. Trigger para executar a função após inserção de novo usuário
...
-- 19. Inserir algumas cotações iniciais para teste
